...
void Material::RTBindTexture(ID3D11DeviceContext * deviceContext, ID3D11ShaderResourceView * shaderResourceView)
{
	pixelShader->RTBindTexture(deviceContext, shaderResourceView);
