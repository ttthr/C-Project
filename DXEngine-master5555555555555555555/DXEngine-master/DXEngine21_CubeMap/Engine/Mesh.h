...
public:
	...
	Mesh(LPCSTR fbxName , LPCTSTR shaderName, D3D11_FILL_MODE fillMode = D3D11_FILL_SOLID
	...
	void CreateRasterizerState1(ID3D11Device* pd3dDevice);
	...
	bool CreateRasterizerState(ID3D11Device* pd3dDevice);
	void BindRasterizerState(ID3D11DeviceContext* pd3dDeviceContext);
	bool IsOn = false;
private:
